...
class corpus :
    ...
    def frekuensi(self, fre):
        ...
        kataAkhir = Counter(tokens)
        fre_akhir = kataAkhir.most_common()
        return(fre_akhir)
    ...
    def typedata(self,tpd):
        ...
        kataAkhir = Counter(tokens)
        # print(kataAkhir)
        kataAkhir.most_common()
        # print(kataAkhir.most_common())
        word = []
        for value, count in kataAkhir.most_common():
            # print(value, count)
            word.append(value)
        return(word)
    ...
    def summarizer(self, vtm):
        ...
        for i in range(0, count_paragraph):
            ...
            for lp in range(0, count_text_paragraph):
                ...
                tfidf.append(val)
                hasil_tfidf = tfidf
                print("Word : ", array_kalimat[lp],". Nilai Bobot :",tfidf[lp])
